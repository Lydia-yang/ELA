...
from TCL.models.xbert import BertConfig, BertForMaskedLM, BertModel
...
def build_text_encoder(config, vision_width, load_text_params=False, use_mlm_loss=False, config_text=None):
    ...
    if config_text is None:
        config_text = BertConfig.from_json_file(config['bert_config'])
...
class XVLM(XVLMBase):
    def __init__(self, config):
        super().__init__(config, load_vision_params=False, load_text_params=True, 
